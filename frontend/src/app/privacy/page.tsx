      ...
      <div className="mx-auto max-w-3xl px-6 py-12">
        ...
        <div className="mt-10 space-y-8 text-sm leading-7 text-slate-600">
          ...
          <section>
            ...
            <p>PassBar uses cookies and browser storage strictly to keep you signed in between sessions. We do not use third-party advertising cookies. Session cookies are issued by our own authentication service.</p>
          </section>
          ...
          <section>
            ...
            <p>We do not sell or share your personal data for marketing purposes. We use a self-hosted PostgreSQL database and AWS (hosting) as infrastructure providers — they process data only to deliver our service.</p>
          </section>
