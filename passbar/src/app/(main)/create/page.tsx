            ...
            <div className="flex items-center justify-between w-full pr-4">
              ...
              {selectedChapters.size > 0 && (
                <span
                  ...
                  className="ml-2 flex items-center justify-center rounded-full p-1 text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition-colors cursor-pointer"
                  onKeyDown={(e) => {
