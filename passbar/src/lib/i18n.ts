...
const en: Dictionary = {
  ...
  'admin.reportsTitle': 'Question Reports and Fix Log',
  'admin.reportsDescription': 'Track and resolve user-reported question bank issues.',
  ...
  'performance.nyPassingReached': 'NY passing standard reached!',
  'performance.focusLevel': 'Focus level',
  'performance.expectedErrorRate': 'Expected error rate',
  'performance.fatigueWarning': 'Focus drops noticeably in later questions (Q61-100). Add stamina training.',
  'performance.fatigueStable': 'Focus stays relatively stable across the 100-question simulation. Keep going.',
};
...
const zhHans: Dictionary = {
  ...
  'admin.reportsTitle': '题目勘误回报与修正日志',
  'admin.reportsDescription': '实时追踪与排除使用者回报的题库错误。',
  ...
  'performance.nyPassingReached': '已达 NY 通过标准！',
  'performance.focusLevel': '专注度',
  'performance.expectedErrorRate': '预期失误率',
  'performance.fatigueWarning': '你在后段题目（Q61-100）的专注度明显下降，需加强体力与耐力训练。',
  'performance.fatigueStable': '你的专注度在整个 100 题模拟中保持相对稳定，继续保持！',
};
...
const zhHant: Dictionary = {
  ...
  'admin.reportsTitle': '題目勘誤回報與修正日誌',
  'admin.reportsDescription': '即時追蹤與排除使用者回報的題庫錯誤。',
  ...
  'performance.currentAccuracy': '目前：{pct}%',
  'performance.nyPassingReached': '已達 NY 通過標準！',
  'performance.focusLevel': '專注度',
  'performance.expectedErrorRate': '預期失誤率',
  'performance.fatigueWarning': '你在後段題目（Q61-100）的專注度明顯下降，需加強體力與耐力訓練。',
  'performance.fatigueStable': '你的專注度在整個 100 題模擬中保持相對穩定，繼續保持！',
};
